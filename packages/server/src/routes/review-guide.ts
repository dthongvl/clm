...
import { generateReviewGuideStream } from '../services/review-guide.js';
...
// parsed ReviewGuide and a terminal `done` (or `error`).
app.post('/stream', async (c) => {
  ...
  logger.ai(`Streaming review guide for PR #${prNumber}`);
