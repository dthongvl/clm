...
- **Pattern Verification** — AI check that a detected pattern (e.g., API change in one file) has corresponding updates at all expected code locations.
...
- **Action** — A user-triggered AI operation (grouping, ai-review, pattern-verification, related-files). Each action has configurable model/variant settings.
...
- **Side Panel** — The right-panel tabbed container for Grouping, AI Review, and Related Files.
